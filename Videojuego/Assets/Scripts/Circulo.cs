...
public class Circulo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Verificar colisi�n con maderas
...
foreach (Enemy enemigo in todosEnemigos)
{
    ...
    float radioEnemigo = 0.5f; // Ajusta esto según el tamaño del sprite o collider

    if (distancia < radio + radioEnemigo)
    {
        // Simula impacto físico
        ...
        Destroy(gameObject);
        return; // salir del Update porque ya colisionó y fue destruida
    }
}
